import { createUstatus,findAllUstatus,updateUstatus,deleteUstatus} from "../../models/user/user-status.model.mjs";
...
const addUserStatus = async (req, res, next) => {
  ...
  const updateUserStatus = async (req, res, next) => {
    ...
    try {
        ...
        const bodyData = req.body;
   let uStatus= await updateUstatus(uStatusId,bodyData,t);
